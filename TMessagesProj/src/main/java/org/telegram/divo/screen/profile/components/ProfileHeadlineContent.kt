...
fun ProfileHeadlineContent(
    ...
    val engagementsTopPaddingState = remember { mutableStateOf(0.dp) }
    val statusBarInsetsRaw = WindowInsets.systemBars.asPaddingValues()
    LaunchedEffect(Unit) {
        engagementsTopPaddingState.value = statusBarInsetsRaw.calculateTopPadding() + 64.dp
    }
    val engagementsTopPadding = engagementsTopPaddingState.value
