...
interface EventService {
    ...
    @POST("event/{id}/set-favourite")
    suspend fun setFavourite(@Path("id") id: Int): EmptyResponse

    @POST("event/{id}/drop-favourite")
    suspend fun dropFavourite(@Path("id") id: Int): EmptyResponse
